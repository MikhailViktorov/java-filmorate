...
public class UserDbStorageTest {
    ...
    void shouldCreate() {
        ...
        user.setEmail("mikhail@email.ru");
        user.setBirthday(LocalDate.of(1990, 1, 1));
        user.setLogin("Mikhail_login");
        ...
        assertThat(users.get(0)).hasFieldOrPropertyWithValue("name", "Mikhail");
        assertThat(users.get(0)).hasFieldOrPropertyWithValue("email", "mikhail@email.ru");
        assertThat(users.get(0)).hasFieldOrProperty("birthday");
        assertThat(users.get(0)).hasFieldOrPropertyWithValue("login", "Mikhail_login");
    }
    ...
    void shouldGetAll() {
        ...
        assertThat(users.get(1)).hasFieldOrPropertyWithValue("id", 1);
        assertThat(users.get(1)).hasFieldOrPropertyWithValue("name", "Mikhail2");
        assertThat(users.get(1)).hasFieldOrPropertyWithValue("email", "mikhail2@email.ru");
        assertThat(users.get(1)).hasFieldOrProperty("birthday");
        assertThat(users.get(1)).hasFieldOrPropertyWithValue("login", "Mikhail_login2");
    }
    ...
    void shouldGetUserById() {
        ...
        assertThat(user).hasFieldOrPropertyWithValue("name", "Mikhail2");
        assertThat(user).hasFieldOrPropertyWithValue("email", "mikhail2@email.ru");
        assertThat(user).hasFieldOrProperty("birthday");
        assertThat(user).hasFieldOrPropertyWithValue("login", "Mikhail_login2");
    }
    ...
    void shouldAddToFriendsAndGetUserFriends() {
        ...
        assertThat(friendsList.get(0)).hasFieldOrPropertyWithValue("name", "Mikhail2");
        assertThat(friendsList.get(0)).hasFieldOrPropertyWithValue("email", "mikhail2@email.ru");
        assertThat(friendsList.get(0)).hasFieldOrProperty("birthday");
        assertThat(friendsList.get(0)).hasFieldOrPropertyWithValue("login", "Mikhail_login2");
    }
